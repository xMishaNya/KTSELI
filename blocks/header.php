    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-end justify-content-center justify-content-lg-start">
            ...
            <ul class="nav navbar col-8 col-lg-auto me-lg-auto mx-auto mb-2 justify-content-center mb-lg-0">
                <li><a href="/index.php" class="px-3">Главная</a></li>
                <li><a href="/news.php" class="px-3">Новости</a></li>
                <li><a href="/blogs.php" class="px-3">Блоги</a></li>
                <li><a href="/faq_open.php" class="px-3">FAQ</a></li>
                <li><a href="/about.php" class="px-3">О нас</a></li>
            </ul>
